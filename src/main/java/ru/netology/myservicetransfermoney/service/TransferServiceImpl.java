...
import ru.netology.myservicetransfermoney.repository.TransferRepository;
...
public class TransferServiceImpl implements TransferService {
    ...
    public MoneyTransferResponse transfer(TransferRequest transferRequest) {
        ...
        final Amount amountFromTestingCard = new Amount(3000000, "RUR");
        ...
        final Card currentTestingCardTo = new Card(cardToNumber, "11/26", "111", amountToTestingCard);
